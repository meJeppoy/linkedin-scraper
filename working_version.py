...
class SecurityManager:
    def __init__(self):
        self.SECRET_KEY = os.environ.get('SECRET_KEY', Fernet.generate_key())
    ...
    def _hash_password(self, password: str) -> str:
        ...
        salt = os.environ.get('SALT', b"fixed_salt_for_demo")
...
def trigger_heyreach_campaign(session_id: str, email: str) -> Optional[Dict]:
    ...
    BEARER_TOKEN = "Unicorn2025@@@"  # Use the same bearer token as main webhook
